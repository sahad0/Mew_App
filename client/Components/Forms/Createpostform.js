    ...
    <>
        <div className="card ">
            ...
            <div className="card-footer d-flex justify-content-between text-muted">
                {content==="" && (<button className="btn btn-primary mt-1 mb-1 ml-6 disabled" onClick={contentextract}>Post</button>)}
                {content && (<button className="btn btn-primary mt-1 mb-1 ml-6 " onClick={contentextract}>Post</button>)}
